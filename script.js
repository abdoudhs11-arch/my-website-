const translations = {
  ...
  ar: {
    ...
    haveProject:'لديك مشروع؟', contactTitle:'لنصنع<br>شيئًا<br><em>يستحيل تجاهله.</em>', startCircle:'ابدأ<br>مشروعًا', artLabel:'دراسة<br>البصمة — 001', identityMotion:'الهوية في حركة', exploreField:'اكتشف المجال', viewAllWork:'شاهد كل الأعمال ↗', visualIdentity:'هوية بصرية + لافتات', digitalExperience:'تجربة رقمية', spatialIdentity:'هوية مكانية', noFilter:'بدون<br>فلتر', formFeeling:'الشكل<br>يتبع<br>الإحساس', enterIdentity:'ادخل<br>إلى<br>الهوية', footerBaseline:'وكالة متكاملة للتواصل واللافتات مقرها الجزائر. نمنح العلامات الطموحة هوية مميزة.', address:'تكسراين، الجزائر — الجزائر', hours:'الأحد–الخميس / 09:00–18:00', legal:'إشعار قانوني', privacy:'الخصوصية', aboutUs:'من نحن', brandingDesign:'الهوية والتصميم', digitalWeb:'الرقمي والويب', allServices:'كل الخدمات ↗'
  }
};
